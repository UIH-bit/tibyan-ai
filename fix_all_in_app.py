...
# New professional HTML template with Profile, Chat Search, and Help & Support
new_html = """
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="en">
...
# Replace old HTML_TEMPLATE inside app.py using regex
if "HTML_TEMPLATE = " in content:
    updated_content = re.sub(r'HTML_TEMPLATE\s*=\s*[\'"].*?[\'"](\s*\n|$)', new_html, content, flags=re.DOTALL)
    with open('app.py', 'w', encoding='utf-8') as f:
        f.write(updated_content)
    print("SUCCESS: app.py updated successfully!")
else:
    print("ERROR: HTML_TEMPLATE not found in app.py")
