...
<head>
    ...
    <style>
        ...
        /* Search Bar & Sorting */
        .search-input { width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; font-size: 14px; margin-bottom: 15px; }
...
<body>
    <div class="container">
        ...
        <!-- 1. CHAT HISTORY WITH SEARCH & TOP SORTING -->
        <div class="card" id="chat-history-section">
        ...
        <!-- 3. PROFESSIONAL HELP & SUPPORT WITH EMAIL -->
    ...
    <script>
        ...
        // Live Search & Automatic Top Sorting for Chat History
        function filterAndSortChats() {
            ...
            // Sort items: matching items float to top
            items.sort((a, b) => {
